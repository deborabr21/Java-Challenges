 ...
 * Lab - Composition
 * 
 * The com.entertainment.Television class.  With constructors, properties, accessor, and business methods.
 * It now defines static members for MIN/MAX volume values
 * It checks incoming volume values for validity 
 * It includes a com.entertainment.DisplayType field to represent its display type
 * 
...
public class Television {
  ...
  // DONE: Create variable for Tuner and instantiate one.
  private Tuner tuner = new Tuner();  // instantiate up front, don't want it to ever be null
  ...
  // DONE: Write methods to get and change the channel
